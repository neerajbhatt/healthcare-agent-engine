"""Eligibility & Coverage Agent — validates coverage, detects eligibility anomalies."""
...
class EligibilityAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            ...
            agent_name="Eligibility & Coverage Agent",
            domain="eligibility",
            wave=1,
        )
    ...
    async def execute(self, context: dict[str, Any]) -> AgentResult:
        ...
        analysis_prompt = f"""Analyze eligibility and coverage data for provider NPI {params['provider_npi']}
...
Focus on:
1. Claims billed during coverage gaps (services without active eligibility)
2. Retroactive eligibility additions (coverage added 30+ days after start date)
3. Correlation between retroactive eligibility and high-cost claims
